...
class Config:
    ...
    output_flip = True  # changed from True  # geometric self-ensemble (see paper)
    ...
    random_crop = True
    crop_size = 200
    noise_std = 0.01  # adding noise to lr-sons. small for real images, bigger for noisy images and zero for ideal case
    ...
    augment_leave_as_is_probability = 1  # changed from 1
    augment_no_interpolate_probability = 0  # changed from 0
